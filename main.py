...
def main():
    ...
    sentences = [
        "Во-первых, путешествия помогают расширить кругозор и познакомиться с другими культурами.",
        "На самом деле, это не так важно.",
        "Однако, если мы посмотрим на статистику, возможно, ситуация изменится.",
